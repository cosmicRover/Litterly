...
class ErrorAlertViewController: UIViewController {
    ...
    let animationView = AnimationView(name: "red-error-cross")
    ...
    func setupOkayButton(){
        ...
        okayButton.addTarget(self, action: #selector(dismissAlert), for: .allTouchEvents)
    }
